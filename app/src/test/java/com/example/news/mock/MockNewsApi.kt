...
class MockNewsApi : NewsApi {
    override suspend fun getTopHeadlines(country: String, apiKey: String): Response<NewsList> {
        delay(1000)
    ...
    override suspend fun deleteArticle(newsId: String, apiKey: String): Response<Unit> {
        delay(1000)
        return Response.success(Unit)
    }
}